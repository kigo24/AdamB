...
""" VGG """
""" from https://github.com/pytorch/vision/blob/v0.10.0-rc2/torchvision/models/vgg.py """
""" other reference: https://github.com/team-approx-bayes/dl-with-bayes/blob/master/classification/models/vgg.py """ 
...
class VGG(nn.Module):
    def __init__(
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1)) # for CIFAR-10
...
def _vgg(
    ...
    **kwargs: Any,
    ...
    model = VGG(
        make_layers(cfgs[cfg], batch_norm=batch_norm), num_classes=num_classes, **kwargs
    )
    #    if pretrained:
